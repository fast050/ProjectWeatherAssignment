package com.example.projectweatherassignment.util
...
val currentWeatherFakeList = listOf<CurrentWeather>(
    currentWeatherFake ,
    currentWeatherFake.copy(cityName = "dubai"),
    currentWeatherFake.copy(cityName = "sharjah")
)
